            ...
            foreach (var package in mainProject.Packages)
            {
                ...
                foreach (var otherProject in solution.Projects.Values)
                {
                    ...
                    if (otherPackage != null &&
                        (otherPackage.Version != package.Version ||
                         otherPackage.TargetFramework != package.TargetFramework))
                    {
                        printName();
                        Console.WriteLine(
                    ...
                    if (otherPackage != null)
                    {
                        foreach (var reference in references)
                        {
                            ...
                            if (otherReference != null && otherReference.Package != reference.Package ||
                                otherReference.PackageVersion != reference.PackageVersion)
                            {
                                printName();
                    ...
                    if (otherPackage == null )
                    {
                        ...
                        {
                            printName();
                            Console.WriteLine($"\t {package.Id} ({otherProject.Name}) TODO missing nuget, but has references");
                        }
                    }
                }
            }
